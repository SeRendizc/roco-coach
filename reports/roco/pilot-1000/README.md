...
| 代码 commit | `b5c245363e44526c6d0482863bfe4bb833e0ee70`（工作区有未提交改动） |
...
| 指标 | 值 | 口径 |
|---|---:|---|
| 吞吐 | 46.5 局/秒 | 端到端墙钟；21.5s / 1000 局 |
...
- 均值 51.11，标准差 35.29，中位 42，最大 214。
...
| `random_legal` | `status_control` | 40 | 15 | 25 | 0 | 0 | 0 |
...
| `status_control` | `random_legal` | 40 | 25 | 15 | 0 | 0 | 0 |
| `status_control` | `shallow_search` | 40 | 19 | 21 | 0 | 0 | 0 |
| `status_control` | `status_control` | 40 | 21 | 19 | 0 | 0 | 0 |
...
| `T1__vs__T1` | 75 | 37 | 37 | 1 |
| `T1__vs__T2` | 75 | 0 | 75 | 0 |
| `T1__vs__T3` | 75 | 12 | 63 | 0 |
