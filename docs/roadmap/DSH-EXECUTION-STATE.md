...
| 项 | 值 |
|---|---|
| HEAD | `cf05b09`（`feat(demo): show the local model really participating, and harden the claims (P0-5, P0-6)`）—— 已推送。（按本文件 §2.1 的口径，文档声明的 HEAD 落后当前一两个提交是正常的：写文档本身也要一次提交。） |
